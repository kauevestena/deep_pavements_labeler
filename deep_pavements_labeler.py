...
class DeepPavementsLabeler:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'DeepPavementsLabeler_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Deep Pavements Labeler')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('DeepPavementsLabeler', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/deep_pavements_labeler/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'quick labeling of samples'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Deep Pavements Labeler'),
                action)
